  ...
  return (
    <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-8 px-4 py-10 sm:gap-10 sm:px-6">
      <div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 border-y border-accent-soft/60 py-4 sm:grid-cols-2 sm:divide-x sm:divide-accent-soft/60">
          <dl className="flex flex-wrap gap-x-10 gap-y-4 sm:pr-6">
            {recipe.servings && (
              <div>
